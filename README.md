...
- **Site Health Check** (`.github/workflows/site-health.yml`) — runs daily on a schedule (and can also be triggered manually), pinging the live site and failing the check if it doesn't respond with a 200 status code.
